...
(function(){
  ...
  // v41ZO #1: the buggy v41ZM closed-order forward-shift (drifted closed orders into the future and
  ...
  // v41ZO #1: open orders use FULL run duration (total gross / cap), not remaining-work days.
...
// ---- 10. v41ZO OVERLOAD GUARD: the gross warm must NOT join the write-churned production_orders
...
// ---- 11. v41ZO MERGE DEBOUNCE GUARD: the background production_orders merge must be throttled so it
...
// ---- 12. v41ZO #2 GROSS SINGLE-SOURCE-OF-TRUTH: planning's protection merge must take the server's
