...
class SapClient {
  ...
  async fetchRecentInvoices({ lookbackDays = 60 } = {}) {
    ...
    const select = `$select=DocEntry,DocNum,CardCode,CardName,DocDate,DocDueDate,DocTotal,VatSum,DocTotalSys,Address,Address2,ShipToCode,PayToCode,Comments,U_SunlocBatch,U_SunlocPO,U_IRN&$expand=DocumentLines`;
